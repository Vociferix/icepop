//! A minimal perfect hash map that keeps the order its entries were inserted.
...
/// Use [`Map`](crate::Map) when the order does not matter.
///
/// `P` selects the lookup interface and is either [`NonPortable`], the default, or
/// [`Portable`]; see the [crate documentation](crate#portability). [`PortableOrderedMap`] names the
/// latter.
///
/// # Example
///
...
///
/// let mut builder = OrderedMap::<&str, u32>::builder();
...
/// Accumulates the entries of a [`OrderedMap`], then freezes them into one.
///
...
///
/// ```
/// use icepop_phf::ordered_map::Builder;
///
...
/// A [`OrderedMap`] that hashes and compares identically on every platform.
///
...
/// The [`Builder`] that produces a [`PortableOrderedMap`].
///
/// # Example
///
/// ```
...
impl<K, V, S, P> OrderedMap<K, V, S, P> {
    ...
    ///
    /// ```
    /// use icepop_phf::{DefaultHasherSeed, OrderedMap};
    ///
    /// let map = OrderedMap::<&str, u32>::builder_with_hasher(DefaultHasherSeed::with_seed(42)).build();
    ///
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// assert!(OrderedMap::<&str, u32>::builder().build().is_empty());
    /// ```
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// let map: OrderedMap<&str, u32> = [("a", 1u32), ("b", 2)].into_iter().collect();
    ///
    /// assert_eq!(map.len(), 2);
    /// ```
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// let map: OrderedMap<&str, u32> = [("b", 2u32), ("a", 1)].into_iter().collect();
    ///
    ...
    /// Returns an iterator over the entries with mutable values, in insertion order.
    ///
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// let mut map: OrderedMap<&str, u32> = [("a", 1u32), ("b", 2)].into_iter().collect();
    ///
    ...
    /// Consumes the map and returns an iterator over its keys, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    /// use icepop_phf::OrderedMap;
    ///
    /// let map: OrderedMap<String, u32> = [("a".to_string(), 1u32)].into_iter().collect();
    ///
    ...
    /// Returns an iterator over the values with mutable access, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    /// use icepop_phf::OrderedMap;
    ///
    /// let mut map: OrderedMap<&str, u32> = [("a", 1u32)].into_iter().collect();
    ///
    ...
    /// Consumes the map and returns an iterator over its values, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    /// use icepop_phf::OrderedMap;
    ///
    /// let map: OrderedMap<&str, u32> = [("a", 1u32)].into_iter().collect();
    ///
    ...
    /// Borrows the entries as a contiguous slice of pairs, in insertion order.
    ///
    ...
    /// let map: OrderedMap<&str, u32> = [("b", 2u32), ("a", 1)].into_iter().collect();
    ///
    /// assert_eq!(map.as_slice(), &[("b", 2), ("a", 1)]);
    /// ```
    ...
    /// let map: OrderedMap<&str, u32> = [("b", 2u32), ("a", 1)].into_iter().collect();
    ///
    /// assert_eq!(map.index(0), Some((&"b", &2)));
    /// assert_eq!(map.index(1), Some((&"a", &1)));
...
impl<K, V, S, P> Builder<K, V, S, P> {
    ...
    /// use icepop_phf::{DefaultHasherSeed, OrderedMap};
    ///
    /// let builder = OrderedMap::<&str, u32>::builder_with_hasher(DefaultHasherSeed::with_seed(42));
    ///
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// let builder = OrderedMap::<&str, u32>::builder_with_capacity(10);
    ///
    ...
    /// Returns an iterator over the entries inserted so far, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Returns an iterator over the inserted keys, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Consumes the builder and returns an iterator over its keys, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Returns an iterator over the inserted values, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// Consumes the builder and returns an iterator over its values, in insertion order.
    ///
    /// # Example
    ///
    /// ```
    ...
    /// use icepop_phf::OrderedMap;
    ///
    /// let mut builder = OrderedMap::<&str, u32>::builder_with_capacity(100);
    /// builder.insert("a", 1);
